            ...
            <div className="px-4 py-4 space-y-4">
              ...
              {memoizedNavItems.map((item) => (
                <div key={item.label} className="flex flex-col space-y-1">
                  {item.subItems ? (
                    <>
                      <span className="text-md font-medium px-2 py-1">{item.label}</span>
                      {item.subItems.map((sub) => (
                        <Link
                          key={sub.label}
                          href={sub.href}
                          className={`pl-4 pr-2 py-2 text-sm rounded-lg ${
                            theme === 'light'
                              ? 'hover:bg-gray-50 text-gray-700'
                    ...
                    <Link
                      href={item.href!}
                      className={`text-md font-medium px-2 py-2 rounded-lg ${
                        theme === 'light'
                          ? 'hover:bg-gray-50 text-gray-700'
                          : 'hover:bg-gray-800 text-gray-100'
                      }`}
              ...
              <div className="pt-4 border-t border-gray-100 dark:border-gray-700">
                {user ? (
                  <>
                    ...
                    <Link
                      href="/profile"
                      className={`block w-full px-2 py-2 text-md rounded-lg ${
                        theme === 'light'
                          ? 'hover:bg-gray-50 text-gray-700'
                          : 'hover:bg-gray-800 text-gray-100'
                      }`}
                    ...
                    <button
                      ...
                      className={`block w-full text-left px-2 py-2 text-md rounded-lg ${
                        theme === 'light'
                          ? 'hover:bg-gray-50 text-gray-700'
                          : 'hover:bg-gray-800 text-gray-100'
                      }`}
