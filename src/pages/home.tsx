...
import { Building, Users, Star, ArrowRight, Heart, Eye, MapPin,} from 'lucide-react';
  ...
  const stats: Omit<StatCardProps, 'theme'>[] = [
    {
      ...
      value: metrics?.totalProperties || 10,
      label: 'Properties Listed',
      description: 'Verified listings across Ethiopia',
    },
    {
      icon: <Users className="w-6 h-6" />,
      value: metrics?.totalUsers || 20,
      label: 'Happy Users',
      description: 'Satisfied customers and growing',
    },
    {
      icon: <Star className="w-6 h-6" />,
      value: Number(metrics?.totalReviews?.toFixed(1)) || 5,
          ...
          <div className="relative z-10 max-w-3xl text-center px-4">
            <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
              ...
              <p className="text-xl md:text-2xl text-indigo-200 mb-8">
                Discover, apply, and secure your perfect rental property in Ethiopia with our comprehensive digital
                platform.
              </p>
              <Link
                href="/properties"
