...
export default function AboutPage() {
  ...
  return (
    <UserLayout>
      ...
      <meta name="description" content="Learn more about Rentify, Ethiopia's premier digital rental marketplace." />
          ...
          <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12">
            ...
            >
              ...
              <ul className="space-y-3">
                {['Simplify rental processes', 'Ensure secure transactions', 'Build trust through reviews'].map((item) => (
                  <li 
                    key={item}
...
const FeatureCard = ({ theme, icon, title, description }: FeatureCardProps) => {
  return (
    <motion.div 
      whileHover={{ y: -5 }}
